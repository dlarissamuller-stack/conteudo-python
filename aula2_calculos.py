...
numero_2 = int(input("Digite o primeiro valor: "))
...
resultado = numero_1 ** numero_2
print("O numero 1 elevado ao numero 2 é: ",resultado)

resultado = numero_1 // numero_2
print("A divisão inteira do numero 1 pelo numero 2 é: ",resultado)
